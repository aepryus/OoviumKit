...
//	let leftExplorer: AetherExplorer = AetherExplorer(aetherView: Oovium.aetherView)
//	let rightExplorer: AetherExplorer = AetherExplorer(aetherView: Oovium.aetherView)
