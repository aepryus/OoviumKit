...
class HeaderEditor: KeyOrbit {
    ...
    init(orb: Orb) {
		...
		topSchematic.add(row: 0, col: 0, w: 1, h: 2, key: Key(text: "footer", uiColor: UIColor.cyan, {
			self.schematic = self.footerSchematic
		}))
		topSchematic.add(row: 0, col: 1, w: 1, h: 2, key: Key(text: "justify", uiColor: UIColor.cyan, {
...
//			self.headerCell.column.renderWidth()
		...
		footerSchematic.add(row: 1, col: 0, w: 1, h: 1, key: Key(text: "match", uiColor: UIColor.cyan, {
		...
		footerSchematic.add(row: 0, col: 1, w: 1, h: 1, key: Key(text: "average", uiColor: UIColor.cyan, {
			self.headerCell.column.aggregate = .average
			self.headerCell.column.render()
			self.headerCell.renderColumn()
			self.schematic = self.topSchematic
		}))
		footerSchematic.add(row: 1, col: 1, w: 1, h: 1, key: Key(text: "running", uiColor: UIColor.cyan, {
		...
		footerSchematic.add(row: 0, col: 2, w: 1, h: 1, key: Key(text: "none", uiColor: UIColor.cyan, {
			self.headerCell.column.aggregate = .none
			self.headerCell.column.render()
			self.headerCell.renderColumn()
			self.schematic = self.topSchematic
		}))
		footerSchematic.add(row: 1, col: 2, w: 1, h: 1, key: Key(text: "count", uiColor: UIColor.cyan, {
			self.headerCell.column.aggregate = .count
			self.headerCell.column.render()
			self.headerCell.renderColumn()
			self.schematic = self.topSchematic
		}))
		footerSchematic.add(row: 2, col: 0, w: 3, h: 1, key: Key(text: "cancel", uiColor: tan, {
			self.schematic = self.topSchematic
		}))
		
		alignmentSchematic.add(row: 0, col: 0, w: 1, h: 2, key: Key(text: "left", uiColor: UIColor.cyan, {
			self.headerCell.column.justify = .left
			self.headerCell.renderColumn()
			self.schematic = self.topSchematic
		}))
		alignmentSchematic.add(row: 0, col: 1, w: 1, h: 2, key: Key(text: "center", uiColor: UIColor.cyan, {
			self.headerCell.column.justify = .center
			self.headerCell.renderColumn()
			self.schematic = self.topSchematic
		}))
		alignmentSchematic.add(row: 0, col: 2, w: 1, h: 2, key: Key(text: "right", uiColor: UIColor.cyan, {
