...
class ColorContext: Context {
	...
	init() {
		super.init(size: CGSize(width: 174, height: 174), offset: UIOffset(horizontal: -84-3, vertical: 0), uiColor: .yellow, schematic: Schematic(rows: 4, cols: 4))
